...
<<generate_cannings>>=
generate_cannings <- function(object, m, included_vector, x, y) {
...
This function must have by design the following arguments:
a `\code{sparmodel}' \code{object}, \code{yz} (response vector),
