...
<<plotmethod, echo=FALSE, fig=TRUE, width=14, height=4.5,prefix.string=Figures/spareg>>=
library(ggplot2)
p1 <- plot(spar_res)+
...
<<plotfacesmeasurereal_best, echo=FALSE, fig=TRUE, width=10, height=3,prefix.string=Figures/spareg>>=
if (is_paper) {
...
@
<<plotfacesmeasurereal_1se, echo=FALSE, fig=TRUE, width=10, height=3,prefix.string=Figures/spareg>>=
if (is_paper) {
...
<<plotfacesobs179, fig=TRUE,echo=FALSE,width=4.5,height=4.5,prefix.string=Figures/spareg>>=
if (is_paper) {
  i <- 179
...
@
<<plotobsvspred179,fig=TRUE,echo=FALSE,width=4.5,height=4.5,prefix.string=Figures/spareg>>=
if (is_paper) {
  id <- 3
...
<<plotdarwinactnumAct,fig=TRUE,echo=FALSE,width=10,height=5,prefix.string=Figures/spareg>>=
if (is_paper) {
...
\centering
\setkeys{Gin}{width=0.8\textwidth}
<<plotdarwincoef,fig=TRUE,echo=FALSE,width=10,height=5,prefix.string=Figures/spareg>>=
if (is_paper) {
  ntasks <- 25
  nfeat <- 18
  reorder_ind <- c(outer(
