...
download.file(paste0(url1, url2), "face_data.mat.Z")
@
<<echo=FALSE>>=
...
@
%
After downloading and uncompressing the \code{.mat} file, we import it in \proglang{R}
...
invisible(file.remove("face_data.mat"))
@
...
invisible(file.remove("darwin.zip"))
invisible(file.remove("data.csv"))
@
